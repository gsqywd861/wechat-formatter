# 公众号AI排版助手 (WeChat Formatter)

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![GitHub stars](https://img.shields.io/github/stars/gsqywd861/wechat-formatter.svg?style=social)](https://github.com/gsqywd861/wechat-formatter/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/gsqywd861/wechat-formatter.svg)](https://github.com/gsqywd861/wechat-formatter/issues)

**在线体验：[https://wechat-formatter-d4c.pages.dev](https://wechat-formatter-d4c.pages.dev)**

公众号AI排版助手是一款专为微信公众号设计的「Markdown 转微信排版」辅助工具。写好 Markdown 文本后，可以使用 AI 一键优化排版结构，再套用 80+ 套不同风格的精美模板，并直接复制粘贴到微信公众平台后台。
...
- **丰富的主题模板**：内置 **80+ 套**精美模板，覆盖 8 大风格分类，并支持自定义主题色。
...
1. **中国风（12套）**：宣纸底色配合中国风配色、典雅宋体与东方韵味装饰，适合传统文化与雅致内容表达。
...
7. **轻松旅游风（20套）**：清新自然的色彩搭配，适合旅行、生活方式类内容。
8. **政务公务风（20套）**：庄重规范，适合政府机关、事业单位的正式发布。
...
```bash
# 克隆项目
git clone https://github.com/gsqywd861/wechat-formatter.git
...
- 在线体验：[https://wechat-formatter-d4c.pages.dev](https://wechat-formatter-d4c.pages.dev)
- GitHub：[https://github.com/gsqywd861/wechat-formatter](https://github.com/gsqywd861/wechat-formatter)
