# 项目指南：公众号AI排版助手 (WeChat Formatter)

## 项目概述

公众号AI排版助手是一款专为微信公众号设计的「Markdown 转微信排版」辅助工具。用户编写 Markdown 文本后，可以使用 AI 一键优化排版结构，再套用 80+ 套不同风格的精美模板，可直接复制粘贴到微信公众平台后台。
...
- **80+ 套模板**分为 8 大类：
  - `neo-brutalism` - 中国风（12套）：宣纸底色、中国风配色、典雅宋体排印
  ...
  - `tourism` - 旅游风（20套）：清新自然，适合旅行内容
  - `government` - 政务风（20套）：庄重规范，适合政府发布
...
- 当前核心定位是：公众号AI排版助手免费在线 Markdown 转微信公众号排版工具，支持 AI 一键优化排版结构、实时预览、样式微调和一键复制发布
...
- 已完成模板扩展到 80+ 套，当前分类为新粗野、极简、商务、文艺、科技、节庆、旅游、政务 8 类
